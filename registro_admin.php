...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errores)) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $stmt = $pdo->prepare("INSERT INTO users (name, lastname, rut, course, year, balance, password, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$nombre, $apellido, $rut, $curso, $anio, $saldo_inicial, $password, $rol]);
...
<div class="container mt-5">
    <h2 class="text-center">Registro de Usuario (Administrador)</h2>
